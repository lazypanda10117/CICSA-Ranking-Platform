...
class EventActivity(models.Model):
    ACTIVITY_TYPE_RACE = 'race'
    EVENT_ACTIVITY_TYPE_RACE = 'race'
    EVENT_ACTIVITY_TYPE_OTHER = 'other'
    ...
    event_activity_type = models.CharField(max_length=50)  # i.e. race
...
class Team(models.Model):
    TEAM_NAME_SUFFIX = 'Team'
    
    TEAM_STATUS_ACTIVE = "active"
    TEAM_STATUS_DORMANT = "dormant"
    TEAM_STATUS_HIDDEN = "hidden"
