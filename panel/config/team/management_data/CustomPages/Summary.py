...
# View Process Functions
    ...
    def abstractFormProcess(self, action, **kwargs):
        try:
            ...
            summary.summary_event_race_score = RequestFunctions.getSingleRequestObj(post_dict, 'summary_race_score')
            summary.summary_event_league_score = RequestFunctions.getSingleRequestObj(post_dict, 'summary_league_score')
